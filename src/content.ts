...
declare global {
	interface Window {
		logseqHighlighterInitialized?: number;
	}
}
...
(function() {
	...
	window.logseqHighlighterInitialized = (window.logseqHighlighterInitialized ?? 0) + 1;
	const myGeneration = window.logseqHighlighterInitialized;
	...
	browser.runtime.onMessage.addListener((request: any, sender, sendResponse) => {
		...
		if (window.logseqHighlighterInitialized !== myGeneration) {
			return;
		}
